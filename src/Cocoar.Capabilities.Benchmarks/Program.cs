...
public class Program
{
    ...
    {
        var switcher = BenchmarkSwitcher.FromTypes(new[] { typeof(TaggedCapabilityBenchmarks) });
        ...
        if (args.Length == 0)
        {
            ...
            Console.WriteLine("   dotnet run -c Release -- --filter \"*Lookup_Tiny_SingleStringTag_CountOnly*\"");
