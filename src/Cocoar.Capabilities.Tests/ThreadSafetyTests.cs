...
public class ThreadSafetyTests
{
    ...
    public async Task Bag_IsImmutable_ThreadSafe()
    {
        ...
        // Act - Multiple threads accessing the bag concurrently
        ...
        // Verify bag state is consistent
    ...
    public async Task Builder_IsNotThreadSafe_ButDetectable()
    {
        ...
        // Act - Multiple threads trying to use the same builder aggressively
        var tasks = Enumerable.Range(0, 10).Select(i => Task.Run(() =>
        {
            try
            {
        ...
        // Assert - We expect exceptions due to race conditions
