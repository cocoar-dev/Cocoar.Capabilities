...
public class RecomposeTests
{
    ...
    Assert.Null(scope.Compositions.FindOrDefault(subject));
        ...
        Assert.NotNull(scope.Composers.FindOrDefault(subject));
        recomposer.Add(new TestCapability("B"));
    ...
    public void Recompose_BothEnabled_TransitionOccurs()
    {
        ...
        var stored = scope.Compositions.FindOrDefault(subject);
        ...
        Assert.Null(scope.Composers.FindOrDefault(subject));
        var storedAfter = scope.Compositions.FindOrDefault(subject);
